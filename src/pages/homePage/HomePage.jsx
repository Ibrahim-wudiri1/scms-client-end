...
//   if (!contact.email || !/\S+@\S+\.\S+/.test(contact.email)) errors.email = "Valid email required";
//   if (!contact.message) errors.message = "Message required";
...
//       className="fixed inset-y-0 right-0 w-72 bg-white dark:bg-gray-900 shadow-2xl z-50 p-6"
//     >
//       <div className="flex items-center justify-between mb-6">
//         <div className="font-bold text-lg text-indigo-800 dark:text-white">Menu</div>
...
//           }}
//           className="w-full text-left py-3 border rounded"
//         >
//           Sign In
//         </button>
...
//         <a
//           href="/signup"
//           className="w-full block text-center bg-emerald-500 text-white py-3 rounded"
//         >
//           Sign Up Free
//         </a>
//       </div>
...
// <section className="min-h-[80vh] flex items-center justify-center text-center px-6 py-12">

// <motion.div {...fadeUp} className="max-w-3xl mx-auto">

// <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-indigo-800 dark:text-white">
// ShopSys – Run Every Shop in Your Complex Like a Pro
// </h1>

// <p className="text-base sm:text-lg mb-8 leading-relaxed text-gray-700 dark:text-gray-300">
...
// <button
// className="bg-emerald-500 px-6 py-3 rounded-lg text-white shadow-lg hover:bg-emerald-600 transition"
...
// />
// {contactErrors.name && <p className="text-red-500 text-sm">{contactErrors.name}</p>}
...
//   className="p-3 border rounded"
// />
// {contactErrors.email && <p className="text-red-500 text-sm">{contactErrors.email}</p>}
...
//   className="p-3 border rounded min-h-[160px]"
// />
// {contactErrors.message && <p className="text-red-500 text-sm">{contactErrors.message}</p>}

// <button className="bg-emerald-500 text-white py-3 rounded hover:bg-emerald-600 transition">
// Send Message
// </button>
